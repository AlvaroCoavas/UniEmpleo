...
(function(){
  ...
  async function api(action, data){
    ...
    const r = await fetch('../Api/chat_api.php', { method:'POST', body: fd });
    return r.json();
  }

  async function refreshConversations(){
    const r = await fetch('../Api/chat_api.php?action=list_conversations');
  ...
  async function openConversation(id){
    ...
    const r = await fetch('../Api/chat_api.php?action=fetch_messages&conversation_id='+id);
    const data = await r.json();
  ...
  async function loadMessages(){
    ...
    const r = await fetch('../Api/chat_api.php?action=fetch_messages&conversation_id='+currentConv);
    const data = await r.json();
  ...
  async function search(q){
    const r = await fetch('../Api/chat_api.php?action=search_participants&q='+encodeURIComponent(q||''));
    const data = await r.json();
