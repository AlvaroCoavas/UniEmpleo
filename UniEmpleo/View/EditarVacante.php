...
if (!$vac) {
  header("Location: /View/MisVacantes.php?error=1&detail=" . urlencode('Vacante no encontrada'));
  exit;
}
?>
<!DOCTYPE html>
...
<body>
  ...
  <div class="layout">
    ...
    <div class="content">
      <form action="/Api/actualizar_vacante.php" method="post" class="formulario">
