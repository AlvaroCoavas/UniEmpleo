...
<head>
    <meta charset="UTF-8">
    <title>Tipo de Registro - Uniempleo</title>
    <link rel="stylesheet" href="/Css/style.css">
</head>
<body>
    <header class="header">
        <h1>Registro en Uniempleo</h1>
    ...
    <main class="registro-main">
        <div class="card">
            ...
            <a href="/View/RegistroEgresados.html" class="btn">Soy Egresado</a>
        </div>

        <div class="card">
            <h2>Registrar como Empresa</h2>
            <p>Publica vacantes y encuentra el talento ideal</p>
            <a href="/View/LoginEmpresa.html" class="btn">Soy Empresa</a>
        </div>
    </main>
