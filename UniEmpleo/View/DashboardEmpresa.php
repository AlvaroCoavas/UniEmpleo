      ...
      <section class="hero" style="--hero-url: url('https://images.unsplash.com/photo-1521737604893-d14cc237f11d?q=80&w=1600&auto=format&fit=crop')">
        <div class="hero__content">
          ...
          <div class="hero__actions">
            <a class="button" href="/View/PublicarVacante.php">Publicar vacante</a>
            <a class="button button--light" href="/View/MisVacantes.php">Mis vacantes</a>
            <a class="button button--light" href="/View/Chat.php">Abrir chat</a>
          </div>
        </div>
      </section>
      ...
      <section class="cta-grid">
        <div class="cta-card">
          ...
          <div class="cta-content">
            ...
            <a class="button" href="/View/PublicarVacante.php">Crear vacante</a>
          </div>
        </div>
        <div class="cta-card">
          ...
          <div class="cta-content">
            ...
            <a class="button" href="/View/MisVacantes.php">Ir a mis vacantes</a>
          </div>
        </div>
        <div class="cta-card">
          <div class="cta-icon">💬</div>
          <div class="cta-content">
            ...
            <a class="button" href="/View/Chat.php">Abrir chat</a>
          </div>
        </div>
      </section>
