  ...
  <div class="layout">
    <aside class="sidebar sidebar--drawer">
      ...
      <div class="menu">
        ...
        <a href="PerfilEgresado.php" class="active">Mi Perfil</a>
    ...
    <div class="content content--two-col">
      <div class="col-left">
        ...
        <div class="card">
          ...
          <?php else: ?>
            <p>No has cargado un CV. <a class="button btn--ghost" href="RegistroEgresados.html">Sube tu CV</a></p>
          <?php endif; ?>
        </div>
      </div>
      <div class="col-right">
            ...
            <div class="profile-cover-inner">
              ...
              <div class="profile-lead">
                ...
                <div class="profile-actions">
                  <a class="button" href="RegistroEgresados.html">Editar perfil</a>
